...
import { UserBodyNotificationInterface } from "../../../../interfaces/components/dashboard";
import { UserInfo } from "../../../../interfaces/store/user/userInterface";
import imageUrlConverter from "../../../../helpers/imageUrlConverter";

const UsersTabelBody = (props: UserBodyNotificationInterface): JSX.Element => {
    const {
        users,
        userInfo,
                ...
                users.map((user, i) => (
                    <tr
                        ...
                        className={`${
                            ...
                            markUserWantToDelete.showAcceptModel
                                ? "bg-darkRed/20"
                                : markUserWantToEdit.user?.id === user.id &&
                                  markUserWantToEdit.showRejectModel
                                ? "bg-lightBlue/20"
                                : userInfo.id === user.id &&
